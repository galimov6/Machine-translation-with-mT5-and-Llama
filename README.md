...
- Evaluation files: This folder contains the files pertaining to the human evaluations of the model
    ...
    * LLAMA-qlora-eval-100k.xlsx contains the human evaluations of the LLaMA model
    * LLAMA-qlora-eval.xlsx contains the human evaluations of the LLaMA model using Unsloth
