...
- Fine_tune_Llama_2.ipynb contains the code for the fine-tuned LLaMA model with QLoRA for 100k lines
- QLoRa_unsloth.ipynb contains the code for the fine-tuned LLaMA model with QLoRA for 80k lines using Unsloth
- QloraLlamaUnslothCOMETandBLEU.ipynb loads the fine-tuned LLaMA model with QLoRA for 80k lines using Unsloth
